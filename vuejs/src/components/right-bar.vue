...
<!--				<b-button type="button" variant="white" class="btn-close btn-close-white ms-auto"-->
...
<!--										<input class="form-check-input" v-model="mode" type="radio"-->
...
<!--								<b-col cols="4">-->
<!--									<div class="form-check card-radio">-->
<!--										<input class="form-check-input" type="radio" v-model="layoutWidth"-->
...
<!--						<div v-if="layoutType == 'vertical' || (layoutType == 'semibox' && visibility == 'show')"-->
<!--							 id="sidebar-size">-->
...
<!--								<b-col cols="4">-->
<!--									<div class="form-check sidebar-setting card-radio">-->
<!--										<input class="form-check-input" v-model="sidebarSize" type="radio"-->
...
<!--								<b-col cols="4">-->
<!--									<div class="form-check sidebar-setting card-radio">-->
<!--										<input class="form-check-input" v-model="sidebarView" type="radio"-->
...
<!--								<b-col cols="4">-->
<!--									<div class="form-check sidebar-setting card-radio">-->
<!--										<input class="form-check-input" v-model="sidebarColor" type="radio"-->
<!--											   name="data-sidebar"-->
...
<!--									<div class="form-check sidebar-setting card-radio">-->
<!--										<input class="form-check-input" type="radio" v-model="sidebarColor"-->
<!--											   name="data-sidebar"-->
...
<!--								<div class="form-check sidebar-setting card-radio">-->
<!--									<input class="form-check-input" v-model="sidebarImage" type="radio"-->
...
<!--								<b-col cols="4">-->
<!--									<div class="form-check sidebar-setting card-radio">-->
<!--										<input class="form-check-input" v-model="preloader" type="radio"-->
<!--											   name="data-preloader"-->
