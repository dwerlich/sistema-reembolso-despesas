						...
						<b-card no-bodyclass="mt-4">
							<b-card-body class="p-4 text-center">
								...
								<div class="mt-4 pt-2">
									...
									<p class="text-muted">Faça Login para acessar novamente.</p>
									<div class="mt-4">
										<router-link to="/login" class="btn btn-success w-100">Login</router-link>
									</div>
								</div>
							</b-card-body>
						</b-card>
				...
				<b-row>
					<b-col lg="12">
						<div class="text-center">
							<p class="mb-0 text-muted">&copy; {{ new Date().getFullYear() }} TechVison.</p>
						</div>
					</b-col>
				</b-row>
			</b-container>
