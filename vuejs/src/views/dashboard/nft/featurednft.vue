                    ...
                    <swiper-slide>
                        <b-card no-body class="explore-box card-animate rounded">
                            ...
                            <b-card-body>
                                ...
                                <h5 class="mb-1 fs-16">
                                    <b-link href="/apps/nft-item-detail" class="text-reset">Walking On Air</b-link>
                                </h5>
                    ...
                    <swiper-slide>
                        <b-card no-body class="explore-box card-animate rounded">
                            ...
                            <b-card-body>
                                ...
                                <h5 class="mb-1 fs-16">
                                    <b-link href="/apps/nft-item-detail" class="text-reset">Filtered Portrait
                                    </b-link>
                                </h5>
                    ...
                    <swiper-slide>
                        <b-card no-body class="explore-box card-animate rounded">
                            ...
                            <b-card-body>
                                ...
                                <h5 class="mb-1 fs-16">
                                    <b-link href="/apps/nft-item-detail" class="text-reset">Patterns Arts & Culture
                                    </b-link>
                                </h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </b-card-body>
