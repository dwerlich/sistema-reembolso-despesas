        ...
        <b-card-body class="p-0">
            <div class="tab-content p-0">
                <div class="tab-pane active" id="buy-tab" role="tabpanel">
                    <div class="p-3 bg-soft-success">
                        <div class="float-end ms-2">
                            <h6 class="text-success mb-0">USD Balance : <span class="text-dark">$12,426.07</span></h6>
                        </div>
                    ...
                    <div class="p-3">
                        ...
                        <div class="mt-3 pt-2">
                            <b-button type="button" variant="success" class="w-100">Buy Coin</b-button>
                        </div>
                    </div>
                </div>

                <div class="tab-pane" id="sell-tab" role="tabpanel">
                    <div class="p-3 bg-soft-danger">
                        <div class="float-end ms-2">
                            <h6 class="text-danger mb-0">USD Balance : <span class="text-dark">$12,426.07</span></h6>
                        </div>
